public class EDFNLCTest {


  public static int sched_call(EDFNLC sched) throws Exception {
  ...
  public static void main(String[] args) throws Exception {
    ...
    EDFNLC sched = new EDFNLC();
    Task first = new Task(3, 1);
    Task second = new Task(4, 2);
